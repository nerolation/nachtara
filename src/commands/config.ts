...
async function setNetworkCommand(networkName: string): Promise<void> {
...
async function setRpcCommand(rpcUrl: string): Promise<void> {
...
async function promptRpc(): Promise<void> {
...
async function clearRpcCommand(): Promise<void> {
