...
import { getCurrentNetwork, getBalance, withdrawFromStealthAddress } from '../lib/network.js';
import { getDiscoveredAddresses } from './receive.js';
import { printHeader, printSubheader, printSuccess, printError, printWarning, printInfo, printStealthAddresses, printTxHash, printKeyValue, printNetworkInfo, startSpinner, stopSpinner, updateSpinner } from '../ui/display.js';
            ...
            const { customAmount } = await inquirer.prompt([
                {
                    ...
                    validate: (input) => {
                        try {
                            ...
                            if (val > selectedAddress.balance)
...
async function withdrawAll(addresses, toAddress, network) {
